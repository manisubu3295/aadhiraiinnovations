...
import { lessonData } from '../data/lessons/big-o'

export default function JavaDsaBigOPage() {
  const navMap = {
  ...
  const { prev, next } = navMap['big-o']
  return (
    <InteractiveLessonPage
      lessonData={lessonData}
      difficulty={['big-o','strings','hash-maps'].includes('big-o') ? 'Foundations' : ['bubble-sort','merge-sort'].includes('big-o') ? 'Intermediate' : 'Advanced'}
      prev={prev}
      next={next}
    />
  )
