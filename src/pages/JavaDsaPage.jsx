...
const LIVE_LESSONS = [
  { n: 1,  title: 'Arrays in Java',       desc: 'Contiguous memory, O(1) access, indexing, loop patterns.', href: '/learn/java-dsa/arrays',        courseHref: '/course/java-dsa/arrays',        time: '18 min', exercises: 6, level: 'Foundations' },
  { n: 2,  title: 'Big O Notation',        desc: 'Runtime growth analysis. O(1), O(n), O(n²), O(log n) — and how to choose.', href: '/learn/java-dsa/big-o',          courseHref: '/course/java-dsa/big-o',          time: '16 min', exercises: 4, level: 'Foundations' },
  { n: 3,  title: 'Strings in Java',       desc: 'Immutability, equals vs ==, charAt, substring, StringBuilder.', href: '/learn/java-dsa/strings',       courseHref: '/course/java-dsa/strings',       time: '14 min', exercises: 4, level: 'Foundations' },
  { n: 4,  title: 'Linked Lists',          desc: 'Node pointers, O(1) front insert/delete, traversal, reversal.', href: '/learn/java-dsa/linked-list',   courseHref: '/course/java-dsa/linked-list',   time: '18 min', exercises: 4, level: 'Core Logic' },
  { n: 5,  title: 'Binary Search',         desc: 'O(log n) search, overflow-safe midpoint, left <= right loop.', href: '/learn/java-dsa/binary-search',  courseHref: '/course/java-dsa/binary-search',  time: '16 min', exercises: 4, level: 'Core Logic' },
  { n: 6,  title: 'Bubble Sort',           desc: 'Adjacent swaps, O(n²), early-exit optimization, swap pattern.', href: '/learn/java-dsa/bubble-sort',   courseHref: '/course/java-dsa/bubble-sort',   time: '14 min', exercises: 3, level: 'Core Logic' },
  { n: 7,  title: 'Merge Sort',            desc: 'Divide and conquer, O(n log n) guaranteed, stable sort.', href: '/learn/java-dsa/merge-sort',    courseHref: '/course/java-dsa/merge-sort',    time: '18 min', exercises: 4, level: 'Core Logic' },
  { n: 8,  title: 'Stacks',                desc: 'LIFO, push/pop/peek, balanced brackets, ArrayDeque.', href: '/learn/java-dsa/stack',         courseHref: '/course/java-dsa/stack',         time: '15 min', exercises: 4, level: 'Data Structures' },
  { n: 9,  title: 'Queues',                desc: 'FIFO, offer/poll, BFS traversal, job scheduling.', href: '/learn/java-dsa/queue',         courseHref: '/course/java-dsa/queue',         time: '14 min', exercises: 4, level: 'Data Structures' },
  { n: 10, title: 'HashMaps in Java',      desc: 'O(1) lookup, frequency counting, two-sum pattern, getOrDefault.', href: '/learn/java-dsa/hash-maps',    courseHref: '/course/java-dsa/hash-maps',    time: '16 min', exercises: 4, level: 'Data Structures' },
  { n: 11, title: 'Recursion',             desc: 'Base case, call stack, memoization, Fibonacci O(2^n) → O(n).', href: '/learn/java-dsa/recursion',     courseHref: '/course/java-dsa/recursion',     time: '17 min', exercises: 4, level: 'Advanced' },
  { n: 12, title: 'Binary Trees',          desc: 'TreeNode structure, in-order traversal, height, recursive pattern.', href: '/learn/java-dsa/binary-trees',  courseHref: '/course/java-dsa/binary-trees',  time: '20 min', exercises: 4, level: 'Advanced' },
]

const COMING_SOON = [
  { title: 'Quick Sort', level: 'Core Logic' },
  { title: 'Hash Sets', level: 'Data Structures' },
  { title: 'Heaps & PriorityQueue', level: 'Data Structures' },
  { title: 'Tree Traversal (DFS / BFS)', level: 'Advanced' },
  { title: 'Binary Search Trees', level: 'Advanced' },
  { title: 'Graphs', level: 'Mastery' },
