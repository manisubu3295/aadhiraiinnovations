...
// Mirrors locationSlugs.js's mechanics exactly (slugify/collision-resolution), but defines its
// own curated set for the /hrm-software/... tree — a district curated for pharmacy isn't
// necessarily curated for HRM, and the two trees are intentionally independent so neither can
// accidentally clobber the other's content.
//
// 8 hand-written, genuinely unique HRM-software city pages live in
// src/components/sections/HrmLocationPageTemplate.jsx — these always win over anything this
// module would otherwise generate for the same place. Weighted toward major business hubs
// (national metros + IT/manufacturing centers) rather than pharmacy's small-town Tamil Nadu
// base, since HRM software buyers concentrate more in cities with a larger density of growing
// businesses.
export const CURATED_SLUGS = new Set([
  'chennai', 'coimbatore', 'bengaluru', 'hyderabad', 'salem', 'tiruchirappalli', 'madurai', 'vellore',
])
...
// still gets its own generated page.
...
// slug -> { district, state, stateSlug, neighboringDistricts } — used by HrmLocalSEOPage.jsx's
