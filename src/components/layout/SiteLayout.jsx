...
const SEO = {
  ...
  '/learn/java-dsa/big-o': {
    title: 'Big O Notation — Time Complexity Guide | Aadhirai Innovations',
    description: 'Master Big O notation. Understand O(1), O(n), O(n²), O(log n) with visual examples and exercises. The foundation of algorithm analysis.',
    ogTitle: 'Big O Notation — DSA | Aadhirai Innovations',
    ogDescription: 'Learn Big O: rank complexities, identify loop patterns, and predict performance at scale.',
    canonical: 'https://www.aadhiraiinnovations.com/learn/java-dsa/big-o',
  },
  '/learn/java-dsa/strings': {
    title: 'Strings in Java — Complete DSA Guide | Aadhirai Innovations',
    description: 'Master Java Strings: immutability, equals vs ==, StringBuilder, charAt, substring. Prevent the most common string bugs.',
    ogTitle: 'Strings in Java DSA | Aadhirai Innovations',
    ogDescription: 'Learn Java Strings: why they are immutable, how to compare safely, and when to use StringBuilder.',
    canonical: 'https://www.aadhiraiinnovations.com/learn/java-dsa/strings',
  },
  '/learn/java-dsa/hash-maps': {
    title: 'HashMaps in Java — Complete DSA Guide | Aadhirai Innovations',
    description: 'Master HashMaps: O(1) put/get, frequency counting, two-sum pattern, getOrDefault. The most important data structure for interviews.',
    ogTitle: 'HashMaps in Java DSA | Aadhirai Innovations',
    ogDescription: 'Learn HashMaps: O(1) lookup, frequency counting pattern, null handling, and two-sum in O(n).',
    canonical: 'https://www.aadhiraiinnovations.com/learn/java-dsa/hash-maps',
  },
  '/learn/java-dsa/bubble-sort': {
    title: 'Bubble Sort in Java — Complete DSA Guide | Aadhirai Innovations',
    description: 'Master bubble sort: adjacent swaps, O(n²) complexity, early-exit optimization. The baseline sorting algorithm every engineer should understand.',
    ogTitle: 'Bubble Sort in Java DSA | Aadhirai Innovations',
    ogDescription: 'Learn bubble sort: O(n²) sorting, swap pattern, early-exit optimization for already-sorted arrays.',
    canonical: 'https://www.aadhiraiinnovations.com/learn/java-dsa/bubble-sort',
  },
  '/learn/java-dsa/merge-sort': {
    title: 'Merge Sort in Java — Complete DSA Guide | Aadhirai Innovations',
    description: 'Master merge sort: divide and conquer, O(n log n) guaranteed, stable sorting. The algorithm that teaches recursive thinking.',
    ogTitle: 'Merge Sort in Java DSA | Aadhirai Innovations',
    ogDescription: 'Learn merge sort: O(n log n) divide-and-conquer, merge two sorted arrays, base case, recursive splitting.',
    canonical: 'https://www.aadhiraiinnovations.com/learn/java-dsa/merge-sort',
  },
  '/learn/java-dsa/binary-trees': {
    title: 'Binary Trees in Java — Complete DSA Guide | Aadhirai Innovations',
    description: 'Master binary trees: TreeNode structure, in-order traversal, tree height, recursive pattern. Foundation for BSTs, heaps, and graphs.',
    ogTitle: 'Binary Trees in Java DSA | Aadhirai Innovations',
    ogDescription: 'Learn binary trees: TreeNode, traversals, height calculation, and the universal recursive tree pattern.',
    canonical: 'https://www.aadhiraiinnovations.com/learn/java-dsa/binary-trees',
  },
